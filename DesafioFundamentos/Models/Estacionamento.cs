    ...
    public class Estacionamento
    {
        ...
        public void RemoverVeiculo()
        {
            ...
            if (VeiculoExiste(placa))
            {
                ...
                {
                    Console.WriteLine("Erro: Entrada inválida. Certifique-se de fornecer um número inteiro válido.");
                }
            }
            else
            {
        ...
        {
            return veiculos.Any(x => string.Equals(x, placa, StringComparison.OrdinalIgnoreCase));
        }
